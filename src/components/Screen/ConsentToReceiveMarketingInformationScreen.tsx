...
function ConsentToReceiveMarketingInformationScreen({navigation}){
    return (
        <SafeAreaView style={styles.rootContainer}>
            <ScrollView>
                <View style={styles.headerContainer}>
                    <StackPopHeaderTitle navigation={navigation} text={'마케팅 수신 동의'} />
                </View>
...
export default ConsentToReceiveMarketingInformationScreen;