...
function LocationBasedServiceConsentScreen({navigation}){
    return (
        <SafeAreaView style={styles.rootContainer}>
            <ScrollView>
                <View style={styles.headerContainer}>
                    <StackPopHeaderTitle navigation={navigation} text={'위치기반 서비스 이용약관'} />
                </View>
...
export default LocationBasedServiceConsentScreen;