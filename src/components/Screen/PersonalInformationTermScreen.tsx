...
function PersonalInformationTermScreen({navigation}){
    return (
        <SafeAreaView style={styles.rootContainer}>
            <ScrollView>
                <View style={styles.headerContainer}>
                    <StackPopHeaderTitle navigation={navigation} text={'개인정보 처리 방침'} />
                </View>
...
export default PersonalInformationTermScreen;