...
function FindPasswordInputEmailScreen({navigation}){
        ...
        <SafeAreaView style={styles.rootContainer}>
            <ScrollView>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.primaryColorTitle}>가입했던 이메일을</Text>
                ...
                <View style={styles.btnContainer}>
                    <PrimaryColorButton 
                        text='인증번호 보내기'
                        onPressHandler={() => navigation.push('findPasswordEmailAuthScreen')}
                    />
                </View>
            </ScrollView>
        </SafeAreaView>
...
export default FindPasswordInputEmailScreen;